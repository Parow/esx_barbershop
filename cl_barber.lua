			...
			ESX.TriggerServerCallback("Parow:GetCoiffeurMontant", function(result)
				if result then
					TriggerEvent('skinchanger:getSkin', function(skin)
						...
						ESX.ShowNotification("~g~Nouveau maquillage acheté")
					end)
		...
		ESX.TriggerServerCallback("Parow:GetCoiffeurMontant", function(result)
			if result then
				TriggerEvent('skinchanger:getSkin', function(skin)
					...
					skin.beard_4 = pp[4]
					TriggerServerEvent('esx_skin:save', skin)
					ESX.ShowNotification("~g~Nouvelle barbe acheté")
				end)
...
function HairCutMenuFct(menu)
	...
	djkq = NativeUI.CreateItem("~g~Validate","")
	djkq:RightLabel("50$")
	menu:AddItem(djkq)
	pp = {}
		...
		ESX.TriggerServerCallback("Parow:GetCoiffeurMontant", function(result)
			if result then
				TriggerEvent('skinchanger:getSkin', function(skin)
					...
					TriggerServerEvent('esx_skin:save', skin)
					ESX.ShowNotification("~g~Nouvelle coupe de cheveux acheté")
				end)
